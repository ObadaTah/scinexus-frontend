...
function NewResearchpaperWidget({ onSubmit }) {
  ...
  const handleSubmit = async () => {
    if (title && description && subject) {
      ...
      try {
        ...
        console.log(
          "Post created successfully: " + JSON.stringify({ mediaIds: mediaIds })
        );
        setOpen(true);
        setTitle("");
        setDescription("");
      ...
      <Card variant="outlined" fullWidth>
        <CardContent>
          ...
          <Button
            ...
            disabled={
              !title.trim() || !description.trim() || !subject.trim() || loading
            }
...
export default NewResearchpaperWidget;
